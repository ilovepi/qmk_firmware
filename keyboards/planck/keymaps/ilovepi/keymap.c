 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | DATA | Ctrl | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    DATA,    KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
/* Data
 * ,-----------------------------------------------------------------------------------.
 * | Tab  | Home |  Up  | End  |      |      |      |   7  |   8  |   9  |  *   | Bksp |
 * |------+------+------+------+------+-------------+------+------+------|------+------|
 * | Esc  | Left | Down | Right|      |      |      |   4  |   5  |   6  |  \   | Tab  |
 * |------+------+------+------+------+------|------+------+------+------+------|------|
